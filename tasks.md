...
- [x] 34. Compactar las acciones de cada tarea en un menu de `...`, manteniendo el check visible y centrando el titulo cuando no haya metadata.
...
## Siguiente paso
Tarea 32: implementar merge basico entre cache local y archivo externo con prioridad por `updated_at` y soporte de `deleted_at`.
